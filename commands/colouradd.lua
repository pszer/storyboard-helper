...
return {
	...
	out = function(t, easing, vector_a, vector_b, args, varargs)
		...
		sb_log:assert(args.start_x, "colouradd out(): no starting R. can't proceed.")
		sb_log:assert(args.start_y, "colouradd out(): no starting G. can't proceed.")
		sb_log:assert(args.start_z, "colouradd out(): no starting B. can't proceed.")
