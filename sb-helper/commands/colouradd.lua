...
return {
	...
	out = function(easing, t, vector_a, vector_b, args, varargs)
		sb.log:assert(args.start_x, "colouradd out(): no starting R. can't proceed.")
		sb.log:assert(args.start_y, "colouradd out(): no starting G. can't proceed.")
		sb.log:assert(args.start_z, "colouradd out(): no starting B. can't proceed.")

		return sb.ir:new("C",easing,t[1],t[2],
