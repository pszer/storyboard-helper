...
return {
	...
	out = function(easing, t, vector_a, vector_b, args, varargs)
		sb.log:assert(args.start_x, "colourmul out(): no starting R. can't proceed.")
		sb.log:assert(args.start_y, "colourmul out(): no starting G. can't proceed.")
		sb.log:assert(args.start_z, "colourmul out(): no starting B. can't proceed.")
